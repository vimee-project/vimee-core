...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vimee-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vimee-tx [options] <hex-tx> [commands]  Update hex-encoded vimee transaction\n" +
            "or:     vimee-tx [options] -create [commands]   Create hex-encoded vimee transaction\n" +
            "\n";
