...
1. Clone the Vimee Core source code:
...
2.  Build Vimee Core:
    ...
    Configure and build the headless Vimee Core binaries as well as the GUI (if Qt is found).
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Vimee Core may be compiled in
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Vimee"

    touch "/Users/${USER}/Library/Application Support/Vimee/vimee.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Vimee/vimee.conf"

The first time you run vimeed, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/vimee-project/vimee/issues/7714)
...
- The Apple keyholder uses this unsigned app to create a detached signature,
  using the script that is also included there. Detached signatures are available from this [repository](https://github.com/vimee-core/vimee-detached-sigs).
